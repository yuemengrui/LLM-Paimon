...
from info.utils.api_servers.llm_base import servers_get_embedding_model_list, servers_embedding_text
...
def support_embedding_model_list(request: Request,
    ...
    return JSONResponse(servers_get_embedding_model_list().json())
