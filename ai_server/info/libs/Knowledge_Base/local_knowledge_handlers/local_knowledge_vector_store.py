...
from info.libs.Knowledge_Base.vector_stores.my_faiss import MyFAISS
...
class KnowledgeVectorStore:
    ...
    def build_vector_store(self, file_path: str, file_hash: str, vector_dir: str, embedding_model_name: str):
        ...
        if not os.path.exists(file_path):
            ...
            embeddings = servers_embedding_text(sentences=sentences, model_name=embedding_model_name)
    ...
    def generate_knowledge_based_prompt(self, embedding_model_name, query, vector_store_dir_list,
        ...
        embedding = servers_embedding_text(sentences=[query], model_name=embedding_model_name)[0]
